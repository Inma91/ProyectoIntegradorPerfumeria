-- ============================================================
--  GOLDEN TALE — Base de datos v3
--  Cambios respecto a v2:
--    · cliente: nombre_completo → nombre + apellido; añadida direccion
--    · empleado: nombre_completo → nombre + apellido; añadida direccion
--    · perfume: añadidos categoria y ml
--    · pago: nueva tabla con forma_pago (Efectivo, Tarjeta, Bizum)
-- ============================================================
...
('PAG001', 1, 'C001', 'E002', 179.98, 'Tarjeta'),
('PAG002', 2, 'C002', 'E003', 120.00, 'Efectivo'),
('PAG003', 3, 'C003', 'E002', 221.49, 'Bizum'),
('PAG004', 4, 'C004', 'E001',  99.95, 'Tarjeta');
...
GROUP BY p.id_pedido, p.id_cliente, nombre_cliente, p.id_empleado, p.fecha, p.estado;
